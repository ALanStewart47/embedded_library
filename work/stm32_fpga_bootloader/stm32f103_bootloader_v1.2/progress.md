...
- Added F0 version query as v1.2 (`72 68 F0 02 12 16`); no flash identity (IROM full).
- Static checks: 89 general + 14 Anlogic. Protocol/HANDOFF/spec updated to match.
- Local Keil rebuild still required before copying `.hex` into v1.2_release.
