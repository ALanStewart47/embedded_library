...
- [x] Add F0 query (`72 68 F0 16` → `72 68 F0 02 12 16`).
- [x] Drop flash identity (IROM full).
- [x] Update protocol, HANDOFF, spec, static checks.
- [ ] Local Keil rebuild and copy `.hex` to release.
